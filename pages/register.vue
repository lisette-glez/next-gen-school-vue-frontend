...
<template>
  <div class="flex items-center min-h-screen p-6 bg-gray-900">
    <div class="flex-1 h-full max-w-md mx-auto overflow-hidden rounded-lg shadow-xl bg-blue-gray-accent-100">
      <div class="flex items-center justify-center p-6 sm:p-12">
        <div class="w-full">
          ...
          <form @submit.prevent="register(form)">
            <div class="mb-1 sm:mb-2">
              ...
              <input placeholder="John" type="text"
                ...
                id="firstName" name="firstName" v-model="form.name" />
            </div>
            <div class="mb-1 sm:mb-2">
              <span class="text-gray-700 dark:text-gray-400">E-mail</span>
              <input placeholder="johndoe@email.com" type="text"
                class="mt-1 flex-grow w-full h-9 px-4 mb-2 transition duration-200 bg-white border border-gray-300 rounded-lg shadow-sm appearance-none focus:border-deep-purple-accent-400 focus:outline-none focus:shadow-outline"
            ...
            <div class="mb-1 sm:mb-2">
              ...
              <input placeholder="***************" type="password"
                class="mt-1 flex-grow w-full h-9 px-4 mb-2 transition duration-200 bg-white border border-gray-300 rounded-lg shadow-sm appearance-none focus:border-deep-purple-accent-400 focus:outline-none focus:shadow-outline"
                id="password_confirmation" name="password_confirmation" v-model="form.password_confirmation" />
            </div>
          ...
          <button
            ...
            <svg class="w-4 h-4 mr-2" aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" x="0px"
